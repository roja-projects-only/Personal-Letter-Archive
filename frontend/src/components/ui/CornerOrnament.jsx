...
export default function CornerOrnament({ position = 'tl', size = 28 }) {
  ...
  return (
    ...
    >
      ...
      <g fill="none" stroke="#9A7000" strokeWidth="1.4" strokeLinecap="round">
        {/* Horizontal curl */}
        <path d="M4 4 Q4 4 14 4 Q20 4 22 8 Q24 12 20 14" />
        {/* Vertical curl */}
        <path d="M4 4 Q4 4 4 14 Q4 20 8 22 Q12 24 14 20" />
        {/* Leaf on horizontal */}
        <path d="M18 5 Q22 2 24 6 Q20 8 18 5Z" fill="#9A7000" opacity="0.6" />
        {/* Leaf on vertical */}
        <path d="M5 18 Q2 22 6 24 Q8 20 5 18Z" fill="#9A7000" opacity="0.6" />
        {/* Small dot at corner */}
        <circle cx="4" cy="4" r="1.2" fill="#9A7000" />
      </g>
    </svg>
  )
}
